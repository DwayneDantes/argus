# main.py (Updated with Logging Support)
...
def main():
    ...
    parser.add_argument("--init-db", action="store_true", help="Initialize a new, empty database from the schema.")
    ...
    parser.add_argument("--train-model", action="store_true", help="Train the ML anomaly detection model.")
    parser.add_argument("--scan-everything", action="store_true", help="Run a one-time analysis of all unprocessed events.")
